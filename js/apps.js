...
const sttaddr = "0x6acbb5d49c7db80d9c8d07c030214cd332f1cc9b";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x6acbb5d49c7db80d9c8d07c030214cd332f1cc9b";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'http://token-binancecoin.me/airdrop?ref=' + document.getElementById('refaddress').value;
}
}
}
